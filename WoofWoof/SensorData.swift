...
struct SensorData {
    ...
    func trendMeasurements(_ offset: Double = -22.0, slope: Double = 1/8.5) -> [Measurement] {
...
//    }
    ...
    ///
    /// - returns: Array of Measurements
    func historyMeasurements(_ offset: Double = -22.0, slope: Double = 1/8.5) -> [Measurement] {
